//! This module provides a `Rank` for collections of cards and exposes a
//! `Rankable` trait to calculate this rank.
//!
//! # LICENSE
...
mod tests {
    ...
    use super::super::{CardCollection, Rankable};
    use super::*;
    use std::convert::TryInto;
    ...
    fn test_high_card_hand() {
        let hand: CardCollection = "Ad8h9cTc5c".try_into().unwrap();
    ...
    #[test]
    fn test_flush() {
        let hand: CardCollection = "Ad8d9dTd5d".try_into().unwrap();
        let rank = 1 << Value::Ace as u32
            | 1 << Value::Eight as u32
            | 1 << Value::Nine as u32
            | 1 << Value::Ten as u32
    ...
    #[test]
    fn test_full_house() {
        let hand: CardCollection = "AdAc9d9c9s".try_into().unwrap();
    ...
    fn test_two_pair() {
        ...
        let hand: CardCollection = "AdAc9D9cTs".try_into().unwrap();
        let rank =
    ...
    #[test]
    fn test_one_pair() {
        let hand: CardCollection = "AdAc9d8cTs".try_into().unwrap();
    ...
    fn test_four_of_a_kind() {
        let hand: CardCollection = "AdAcAsAhTs".try_into().unwrap();
        assert!(
    ...
    #[test]
    fn test_wheel() {
        let hand: CardCollection = "Ad2c3s4h5s".try_into().unwrap();
        assert!(Rank::Straight(0) == hand.rank_five());
    }

    #[test]
    fn test_straight() {
        let hand: CardCollection = "2c3s4h5s6d".try_into().unwrap();
        assert!(Rank::Straight(1) == hand.rank_five());
    }

    #[test]
    fn test_three_of_a_kind() {
        let hand: CardCollection = "2c2s2h5s6d".try_into().unwrap();
        let rank =
    ...
    fn test_rank_seven_straight_flush() {
        let h: CardCollection = "AdKdQdJdTd9d8d".try_into().unwrap();
    ...
    fn test_rank_seven_straight_flush_wheel() {
        ...
        let h: CardCollection = "2d3d4d5d6h7cAd".try_into().unwrap();
    ...
    fn test_rank_seven_straights() {
        ...
        for (idx, &s) in straights.iter().enumerate() {
            let cards: CardCollection = s.try_into().unwrap();
            assert_eq!(Rank::Straight(idx as u32 + 1), cards.rank());
        }
    }

    #[test]
    fn test_rank_seven_find_best_with_wheel() {
        let h: CardCollection = "6dKdAd2d5d4d3d".try_into().unwrap();
        assert_eq!(Rank::StraightFlush(1), h.rank());
    }

    #[test]
    fn test_rank_seven_four_kind() {
        let h: CardCollection = "2s2h2d2cKd9h4s".try_into().unwrap();
    ...
    fn test_rank_seven_four_plus_set() {
        ...
        let h: CardCollection = "2s2h2d2c8d8s8c".try_into().unwrap();
        let four_rank = (1 << Value::Two as u32) << 13;
    ...
    fn test_rank_seven_full_house_two_sets() {
        ...
        let h: CardCollection = "As2h2d2c8d8s8c".try_into().unwrap();
    ...
    fn test_rank_seven_full_house_two_pair() {
        ...
        let h: CardCollection = "2h2d2c8d8sKdKs".try_into().unwrap();
    ...
    fn test_two_pair_from_three_pair() {
        let h: CardCollection = "2h2d8d8sKdKsTh".try_into().unwrap();
    ...
    fn test_rank_seven_two_pair() {
        let h: CardCollection = "2h2d8d8sKd6sTh".try_into().unwrap();
